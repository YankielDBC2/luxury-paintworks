...
import { ChevronRight, CheckCircle2, ChevronDown, ChevronUp, MapPin, Phone, Clock, Shield, Star, Award } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-12 mb-12 md:mb-16">
            <div className="lg:col-span-2 space-y-8 md:space-y-12">
              ...
              {/* Benefits */}
              {service.benefits && (
                <div className="bg-gradient-to-r from-blue-50 to-white rounded-2xl md:rounded-3xl p-4 md:p-8 border border-blue-100">
                    ...
                    {service.whyChoose.map((item, i) => (
                      <div key={i} className="flex items-center gap-2 md:gap-3">
                        <div className="bg-blue-100 p-1.5 md:p-2 rounded-lg flex-shrink-0">
                          <CheckCircle2 className="text-blue-600 w-4 h-4 md:w-5 md:h-5" />
                        </div>
            ...
            <div className="space-y-4 md:space-y-6">
              {/* CTA Box */}
              <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl md:rounded-3xl p-4 md:p-6 text-white shadow-xl">
                <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3">
                  {t('needService')} {service.title}?
                </h3>
