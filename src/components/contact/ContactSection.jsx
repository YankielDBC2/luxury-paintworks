    ...
    <section id="contacto" className="py-12 md:py-20 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-extrabold text-slate-900 mb-3">
            ...
            <div className="relative z-10 p-6 md:p-10 lg:p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-10">
                ...
                <div className="bg-white/10 backdrop-blur-xl rounded-xl md:rounded-2xl p-4 md:p-5 border border-white/20 hover:bg-white/15 transition-all group">
                  <div className="flex flex-col items-center text-center">
                    <div className="bg-gradient-to-br from-blue-400 to-blue-600 p-3 rounded-xl md:rounded-2xl mb-3 group-hover:scale-110 transition-transform shadow-lg">
                      <Phone size={24} className="text-white" />
                    </div>
                    <p className="text-xs text-blue-300 font-bold uppercase tracking-wider mb-1">
                      Llamadas & WhatsApp
                    </p>
                    <a href={`tel:${contactInfo.phoneRaw}`} className="text-lg md:text-xl font-bold text-white hover:text-blue-300 transition-colors">
                      {contactInfo.phone}
                    </a>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-xl rounded-xl md:rounded-2xl p-4 md:p-5 border border-white/20 hover:bg-white/15 transition-all group">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <a href={`mailto:${contactInfo.email}`} className="text-sm md:text-base lg:text-lg font-bold text-white hover:text-blue-300 transition-colors break-all leading-tight">
                      {contactInfo.email}
                    </a>
                  </div>
                </div>
              ...
              <div className="flex justify-center gap-3 md:gap-4 mb-6 md:mb-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white/10 backdrop-blur-md p-3 rounded-xl hover:bg-white/20 transition-all border border-white/20 group shadow-lg hover:shadow-xl transform hover:scale-110"
                >
                  <Instagram size={24} className="text-white group-hover:text-pink-400 transition-colors" />
                </a>
                <a
                  ...
                  className="bg-white/10 backdrop-blur-md p-3 rounded-xl hover:bg-white/20 transition-all border border-white/20 group shadow-lg hover:shadow-xl transform hover:scale-110"
                >
                  <Facebook size={24} className="text-white group-hover:text-blue-400 transition-colors" />
                </a>
                <a
        ...
        <div className="mt-8 md:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          <div className="text-center">
            <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-5 shadow-lg border border-slate-200 hover:shadow-xl transition-all">
              <p className="text-2xl md:text-3xl font-bold text-blue-600 mb-1">10+</p>
              <p className="text-xs md:text-sm font-semibold text-slate-700">Años de Experiencia</p>
            </div>
          </div>
          <div className="text-center">
            <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-5 shadow-lg border border-slate-200 hover:shadow-xl transition-all">
              <p className="text-2xl md:text-3xl font-bold text-blue-600 mb-1">500+</p>
              <p className="text-xs md:text-sm font-semibold text-slate-700">Proyectos Completados</p>
            </div>
          </div>
          <div className="text-center">
            <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-5 shadow-lg border border-slate-200 hover:shadow-xl transition-all">
              <p className="text-2xl md:text-3xl font-bold text-blue-600 mb-1">100%</p>
